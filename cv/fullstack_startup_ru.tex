...
\section{Опыт Работы}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Fullstack Developer (Python, React)}{Май 2025 - Настоящее время}
      {KEYGO (управление недвижимостью)}{Москва, Россия (Удалённо)}
      \resumeItemListStart
        \resumeItem{Реструктурировал frontend-кодовую базу в соответствии с принципами FSD-архитектуры и спроектировал комплексную систему виджетов и компонентов}
        \resumeItem{Создал host-приложение с нуля и обеспечиваю полную техническую поддержку как staff-, так и host-приложений}
      \resumeItemListEnd
      \small\vspace{-3pt}\begin{itemize}[leftmargin=0.15in, label={}]
    \item{\textbf{Стек:} Python, FastAPI, MongoDB, Redis, React, Next.js, TypeScript, Redux, Sass}
    \end{itemize}
    \vspace{-8pt}
    \resumeSubheading
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Работал с фаундерами для реализации кастомных высокоэффективных решений для B2B клиентов}
      \resumeItemListEnd
      \small\vspace{-3pt}\begin{itemize}[leftmargin=0.15in, label={}]
...
\section{Проекты}
    ...
    \resumeProjectHeading
      ...
      \vspace{-10pt}
      \resumeItemListStart
        \resumeItem{Разработал AI-продукт с нуля как единственный инженер и продуктовый владелец: спроектировал архитектуру, реализовал backend, frontend и тг-бота, внедрил платёжную систему, аналитику, уведомления, локализацию, реферальную программу, CI/CD. Привлёк 700 пользователей, добился retention первого дня/недели/месяца 59\%/33.8\%/23\%. Проходили онбординг 92\%, тратили бесплатный лимит 52\%, более 5\% платили. Принимал все продуктовые и UX-решения на основе аналитикии и интервью.}
      \resumeItemListEnd
      \small\vspace{-3pt}\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \resumeProjectHeading
      ...
      \vspace{-10pt}
        \resumeItemListStart
        \resumeItem{Создал fullstack веб-приложение для управления производством (200+ сотр.): динамические формы, drag-and-drop UI, RBAC, real-time аналитика. Сократил время планирования на 200+ часов/мес.}
      \resumeItemListEnd
      \small\vspace{-3pt}\begin{itemize}[leftmargin=0.15in, label={}]
