...
\item{Fullstack Developer with strong product mindset and startup experience: deeply immerse myself in business context, ask "why" and "what for" questions, and actively participate in product decisions. Confident working with Python (FastAPI), Vue, React and related stack: from API design and AI/LLM integrations to building user-friendly interfaces. Prefer rapid iterations and actions over discussions, take technical ownership and deliver tasks to stable results.}
\end{itemize}
