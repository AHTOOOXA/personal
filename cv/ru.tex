...
\section{Опыт Работы}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Отвечаю за host-приложение и staff-приложение, перестроил все страницы и компонентную систему}
        \resumeItem{Разработал архитектуру и реализовал full-stack решение с Python backend и React frontend}
      \resumeItemListEnd
      \small\vspace{-3pt}\begin{itemize}[leftmargin=0.15in, label={}]
    \item{\textbf{Стек:} Python, React, веб-разработка, управление недвижимостью}
    \end{itemize}
    \vspace{-8pt}
    \resumeSubheading
